        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ExtendedIdentityUserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_IdentityUserClaim_ExtendedIdentityUsers_ExtendedIdentityUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IdentityUserLogin<string>", x => new { x.LoginProvider, x.ProviderKey, x.UserId });
                    table.ForeignKey(
                        name: "FK_IdentityUserLogin<string>_ExtendedIdentityUsers_ExtendedIdentityUserId",
                        column: x => x.ExtendedIdentityUserId,
                        principalTable: "ExtendedIdentityUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_IdentityUserRole<string>_ExtendedIdentityUsers_ExtendedIdentityUserId",
                        column: x => x.ExtendedIdentityUserId,
                        principalTable: "ExtendedIdentityUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Friendship_FriendsWithId",
                table: "Friendship",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IdentityUserClaim_ExtendedIdentityUserId",
                table: "IdentityUserClaim",
                column: "ExtendedIdentityUserId");

            migrationBuilder.CreateIndex(
                name: "IX_IdentityUserLogin<string>_ExtendedIdentityUserId",
                table: "IdentityUserLogin<string>",
                column: "ExtendedIdentityUserId");

            migrationBuilder.CreateIndex(
                name: "IX_IdentityUserRole<string>_ExtendedIdentityUserId",
